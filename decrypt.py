...
def main():
    ...
    # 设置默认值，优先从环境变量读取
    default_server = os.environ.get('COOKIECLOUD_SERVER', 'https://cookiecloud.example.com')
    default_uuid = os.environ.get('COOKIECLOUD_UUID', 'your_uuid_here')
    default_password = os.environ.get('COOKIECLOUD_PASSWORD', 'your_password_here')

    bilibili_uid = os.environ.get('BILIBILIUID', '12345678')
    
    # 网站和对应的环境变量名映射
    WEBSITE_ENV_MAPPING = {
        'bilibili.com': f'BILIBILI_COOKIE_{bilibili_uid}',
        'zhihu.com': 'ZHIHU_COOKIES',
        'xiaohongshu.com': 'XIAOHONGSHU_COOKIE',
        'x.com': 'TWITTER_AUTH_TOKEN'
    }
